  ...
  return (
    <div className="w-full">
      ...
      <form onSubmit={handleSubmit} className="w-full max-w-6xl mx-auto bg-neutral-900/90 backdrop-blur-md border border-white/10 rounded-2xl p-4 flex flex-col md:flex-row items-stretch gap-3 shadow-2xl relative z-10">
        ...
        <button
          type="submit"
          className="md:self-end bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white font-bold text-sm px-8 py-3.5 rounded-xl transition-all active:scale-[0.98] whitespace-nowrap shadow-lg shadow-blue-500/10 cursor-pointer"
        >
